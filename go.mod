module github.com/kunitsuinc/certcounter
...
require (
	...
	github.com/kunitsuinc/grpcutil.go v0.0.1
	github.com/kunitsuinc/rec.go v0.0.1
	github.com/kunitsuinc/util.go v0.0.14-0.20221010195358-46259854168e
